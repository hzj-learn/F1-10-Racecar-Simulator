...
This is a fork of the lightweight 2D simulator of the UPenn F1/10 Racecar (<https://github.com/f1tenth/f110_ros>).
Most of the following document was copied from the Penn's repo; we plan to update it in the future.

The simulator can be built with ROS, or it can be used as a standalone C++ library.
Although this document uses ROS Melodic in the instructions, the simulator has been verified to work in ROS Kinetic.
